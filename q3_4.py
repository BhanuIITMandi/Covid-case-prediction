...
rmse_q4, mape_q4=ARmodel(train, test, i-1)
print("Q4--> Lag(heuristic) value is :", i-1)
print(f"Q4--> RMSE value for lag value = {i-1} is :",rmse_q4[0])
print(f"Q4--> MAPE value for lag value = {i-1} is :",mape_q4)